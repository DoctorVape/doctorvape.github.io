		...
		$.ajax({
			...
			beforeSend: function () {
			   ...
			   $("#contact-form").fadeIn(300,function(){
				   	$(this).replaceWith("<img id=\"contact-form\" src=\"http://i.stack.imgur.com/MnyxU.gif\">");
			   });
			},
...
function check() {
    var scrollbnt = document.getElementById("scrollTop");

    if (window.scrollY < 900) {
        scrollbnt.style.display = "none";

    }
    else {
        scrollbnt.style.display = "block";
